...
import {NoteNavBar2, UINewNote, NoteCardCollection, ProfileNavBar, HomeNavBar, HomePage, CreateProf, ProfileCollection} from "./ui-components";
  ...
  return (
    <div className="App"><header className="App-header">
      ...
      <Route exact path='/' element={<div><HomeNavBar/><HomePage/></div>}/>
       ...
       <Route exact path='/editprof/:cid' element={<EditProfileR/>} />

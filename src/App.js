...
import {NoteNavBar2, UINewNote, NoteCardCollection, ProfileNavBar, HomeNavBar, HomePage, ProfileCollection, FriendsPage, CreateProf, EditProf} from "./ui-components";
...
class App extends Component {
  ...
  return (
    <div className="App"><header className="App-header">
      ...
      <Route exact path='/editprof/:cid' element={<EditProf/>} />
